        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map(({ title, description, href, cta }, i) => (
            <FadeUp key={href} delay={i * 0.1}>
              <Link
                href={href}
                className="group flex flex-col h-full p-7 rounded-2xl bg-warm-dim border border-warm-dim hover:border-brand/40 hover:shadow-md transition-[color,background-color,border-color,box-shadow] duration-200"
              >
