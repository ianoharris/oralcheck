    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {articles.map(({ href, tag, title, description, icon }, i) => (
        ...
        >
          <Link
            href={href}
            className="group flex flex-col h-full bg-warm-dim rounded-2xl border border-warm-dim p-6 hover:border-brand/40 hover:shadow-md transition-[color,background-color,border-color,box-shadow] duration-200"
          >
